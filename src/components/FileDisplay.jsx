...
export default function FileDisplay(props) {
    ...
    return (
        <main className='flex-1 p-4 flex flex-col text-center gap-3 sm:gap-4 justify-center pb-20 w-72 sm:w-96 max-w-full mx-auto'>
            ...
            <div className='flex items-center justify-between gap-4'>
                ...
                <button className='spacialBtn px-3 p-2 rounded-lg text-blue-400 flex items-center gap-2 font-medium'>
                    <p>Transcribe</p>
